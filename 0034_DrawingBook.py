...
def solve(bookPages, pageNumber):
    if pageNumber % 2 == 0:
      frontCount = pageNumber/2
    else:
      frontCount = (pageNumber-1)/2
    ...
    backCount = (bookPages - pageNumber)/2

    return (frontCount if frontCount < backCount else backCount)
